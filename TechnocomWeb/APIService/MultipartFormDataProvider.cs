...
{
    public class MultipartFormDataProvider : MultipartStreamProvider
    {
        private Dictionary<string, string> _formData = new Dictionary<string, string>();

        private Dictionary<string, HttpContent> _fileContents = new Dictionary<string, HttpContent>();
        ...
        /// </summary>  
        public Dictionary<string, HttpContent> Files
        {
