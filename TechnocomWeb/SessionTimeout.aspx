<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionTimeout.aspx.cs" Inherits="TechnocomWeb.SessionTimeout" %>
    ...
    <div class="row">
        <div class="col-md-12 page-404">
            ...
            <div class="details">
                ...
                <p class="text-left">
                   <span style="font-size:13px;"> Session Timed Out <a href="LoginPage.aspx" class="text-primary">Click here</a> to login again.</span>
                </p>
                <p class="text-left">
