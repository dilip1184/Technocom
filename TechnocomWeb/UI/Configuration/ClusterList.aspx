<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Shared/default.Master"
    AutoEventWireup="true" CodeBehind="ClusterList.aspx.cs" Inherits="TechnocomWeb.UI.Configuration.ClusterList"
...
<asp:Content ID="ContentBody" runat="server" ContentPlaceHolderID="placeHolderBody1">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>Cluster</label>
                                <Technocomctrl:ctlTextBox ID="txtClusterNameSearch" runat="server" class="form-control"
                                    MaxLength="100" />
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group" style="padding-top: 20px;">
                                <label>&nbsp;</label>
                                <asp:Button ID="btnSearchCluster" runat="server" CssClass="btn btn-sm yellow" Text="Search"
        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark bold uppercase">Cluster List</span>
                </div>
                <div class="pull-right">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-sm btn-primary" Text="Add Cluster"
            ...
            <div class="portlet-body" style="padding-top: 18px;">
                <div class="table-responsive">
                    <Technocomctrl:ctlGridView ID="gridViewList" runat="server" Width="100%" AutoGenerateColumns="false"
                        AutoBind="false" DataKeyNames="ClusterId" CssClass="table table-bordered table-hover table-striped" OnRowCommand="gridViewList_RowCommand"
                        NoCheckCaption="Location" EmptyDataText="No Record Found!">
                        <Columns>
                            <asp:BoundField HeaderText="ClusterId" DataField="ClusterId" SortExpression="ClusterId" Visible="false" />
                            ...
                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="100px">
                                <ItemTemplate>
                                    <asp:Button ID="btnEdit" runat="server" CommandName="EditRow" Text="" CssClass="btn btn-sm btn-success btn-refrsh"
                                        CommandArgument='<%# Eval("ClusterId")%>'></asp:Button>&nbsp;&nbsp;
    ...
    <div class="portlet light" id="DIVDetail" runat="server" visible="false">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list-alt txt-theme" aria-hidden="true"></i>
                <span class="caption-subject txt-theme bold uppercase">Cluster Details</span>
            </div>
        </div>
        <div class="portlet-body">
            <div class="row">
                <div class="col-sm-12 no-padding">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="required">Cluster Name</label>
                                <Technocomctrl:ctlTextBox ID="txtClusterName" CssClass="form-control" runat="server"
                                    MaxLength="100" MetaMandatory="true" MetaValidationRequired="true" MetaCaption="Cluster Name"
